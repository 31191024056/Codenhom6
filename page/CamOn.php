...
<div class="content-dathang" >    
    <div class="tongnd">
        <div class="loicamon">
            <div class="title-dathang"><h1><b>Cảm ơn bạn đã đặt hàng !</b></h1></div>
            <br> <br>
            <h2>Chúng tôi sẽ liên hệ bạn để xác nhận đơn hàng trong thời gian sớm nhất!
                <br> Chúc bạn mạnh khỏe và thành công!!
            </h2>
            <br><br><br><br><br><br>   
        </div>     
...
/* --- */
    ...
    .noidung{width:100%;display: flex; justify-content: space-between; }
    ...
    .product-thongtin h3 {font-size: 18px; color: black;}       
